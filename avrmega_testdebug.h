...
#ifndef AVRMEGA_TESTDEBUG_H
#define AVRMEGA_TESTDEBUG_H

/* ******************************************************************************
 * TEST AND DEMO FUNCTION DATA STRUCTURES
 * ******************************************************************************
 */
// This is a list of registers that can be worked through to test all registers
...
// This is a sequence of 0 to 255d for testing 8 bit registers
// and a define for use in declarations using this array
...
#endif // DEFINED AVRMEGA_TESTDEBUG_H
